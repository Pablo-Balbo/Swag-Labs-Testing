...
const expectedBackpackOriginalSrc = 'sauce-backpack-1200x1500.34e7aa42.jpg';
const expectedBikeLightOriginalSrc = 'bike-light-1200x1500.a0c9caae.jpg';
const expectedBoldTShirtOriginalSrc = 'bolt-shirt-1200x1500.c0dae290.jpg';
const expectedFleeceJacketOriginalSrc = 'sauce-pullover-1200x1500.439fc934.jpg';
const expectedOnesieOriginalSrc = 'red-onesie-1200x1500.1b15e1fa.jpg';
const expectedRedTShirtOriginalSrc = 'red-tatt-1200x1500.e32b4ef9.jpg';
...
describe('Inventory page tests', () => {
    describe('Check images', () => {
        it('Check Backpack img', () => {
            ...
            expect(imgBackpackSrc).toContain(expectedBackpackOriginalSrc);
        });
        ...
        it('Check Bike Light img', () => {
            ...
            expect(imgBikeLghtSrc).toContain(expectedBikeLightOriginalSrc);
        });
        ...
        it('Check Bolt T-Shirt img', () => {
            ...
            expect(imgBoltTShirtSrc).toContain(expectedBoldTShirtOriginalSrc);
        });
        ...
        it('Check Fleece Jacket img', () => {
            ...
            expect(imgFleeceJacketSrc).toContain(expectedFleeceJacketOriginalSrc);
        });
        ...
        it('Check Onesie img', () => {
            ...
            expect(imgOnesieSrc).toContain(expectedOnesieOriginalSrc);
        });
        ...
        it('Check RedTShirt img', () => {
            ...
            expect(imgRedTShirtSrc).toContain(expectedRedTShirtOriginalSrc);
        });
    });
